...
#
# ⚠ RE-RECORDED AGAIN by TBD-273, which added `differs_from_series`, by the
# same procedure: live capture, then each response parsed, the new key stripped
# (asserted to sit right after `is_reverted` and be false on every row, since
# no fixture row is recurring), and the remainder asserted byte-identical to
# the previous bytes.
#
...
CONTROL_SNAPSHOTS: dict[str, str] = {
    "category_id=1": (
        "{\"items\":[{\"id\":6,\"account_id\":1,\"account_name\":\"Acct\",\"category_id\":1,\"category_name\":\"Home\",\"descr"
        "iption\":\"leg in\",\"amount\":\"50.00\",\"type\":\"income\",\"status\":\"settled\",\"linked_transaction_id\":5,\"link"
        "ed_account_name\":null,\"recurring_id\":null,\"date\":\"2026-01-09\",\"settled_date\":\"2026-01-09\",\"is_import"
        "ed\":false,\"is_manual_adjustment\":false,\"is_reverted\":false,\"differs_from_series\":false,\"tags\":[]},{\""
        "id\":5,\"account_id\":1,\"account_name\":\"Acct\",\"category_id\":1,\"category_name\":\"Home\",\"description\":\"leg"
        " out\",\"amount\":\"50.00\",\"type\":\"expense\",\"status\":\"settled\",\"linked_transaction_id\":6,\"linked_account"
        "_name\":null,\"recurring_id\":null,\"date\":\"2026-01-09\",\"settled_date\":\"2026-01-09\",\"is_imported\":false,"
        "\"is_manual_adjustment\":false,\"is_reverted\":false,\"differs_from_series\":false,\"tags\":[]},{\"id\":4,\"acc"
        "ount_id\":1,\"account_name\":\"Acct\",\"category_id\":2,\"category_name\":\"Utilities\",\"description\":\"sub row\""
        ",\"amount\":\"40.00\",\"type\":\"expense\",\"status\":\"settled\",\"linked_transaction_id\":null,\"linked_account_n"
        "ame\":null,\"recurring_id\":null,\"date\":\"2026-01-08\",\"settled_date\":\"2026-01-08\",\"is_imported\":false,\"i"
        "s_manual_adjustment\":false,\"is_reverted\":false,\"differs_from_series\":false,\"tags\":[]},{\"id\":3,\"accou"
        "nt_id\":1,\"account_name\":\"Acct\",\"category_id\":1,\"category_name\":\"Home\",\"description\":\"rejected\",\"amou"
        "nt\":\"30.00\",\"type\":\"expense\",\"status\":\"settled\",\"linked_transaction_id\":null,\"linked_account_name\":n"
        "ull,\"recurring_id\":null,\"date\":\"2026-01-07\",\"settled_date\":\"2026-01-07\",\"is_imported\":false,\"is_manu"
        "al_adjustment\":false,\"is_reverted\":true,\"differs_from_series\":false,\"tags\":[]},{\"id\":2,\"account_id\":"
        "1,\"account_name\":\"Acct\",\"category_id\":1,\"category_name\":\"Home\",\"description\":\"adjustment\",\"amount\":\""
        "20.00\",\"type\":\"expense\",\"status\":\"settled\",\"linked_transaction_id\":null,\"linked_account_name\":null,\""
        "recurring_id\":null,\"date\":\"2026-01-06\",\"settled_date\":\"2026-01-06\",\"is_imported\":false,\"is_manual_ad"
        "justment\":true,\"is_reverted\":false,\"differs_from_series\":false,\"tags\":[]},{\"id\":1,\"account_id\":1,\"ac"
        "count_name\":\"Acct\",\"category_id\":1,\"category_name\":\"Home\",\"description\":\"ordinary\",\"amount\":\"10.00\","
        "\"type\":\"expense\",\"status\":\"settled\",\"linked_transaction_id\":null,\"linked_account_name\":null,\"recurri"
        "ng_id\":null,\"date\":\"2026-01-05\",\"settled_date\":\"2026-01-05\",\"is_imported\":false,\"is_manual_adjustmen"
        "t\":false,\"is_reverted\":false,\"differs_from_series\":false,\"tags\":[]}],\"total\":6,\"limit\":50,\"offset\":0"
        "}"
    ),
    "limit=50&offset=0": (
        "{\"items\":[{\"id\":6,\"account_id\":1,\"account_name\":\"Acct\",\"category_id\":1,\"category_name\":\"Home\",\"descr"
    ...
    "sort_by=amount&sort_dir=asc": (
        "{\"items\":[{\"id\":1,\"account_id\":1,\"account_name\":\"Acct\",\"category_id\":1,\"category_name\":\"Home\",\"descr"
        "iption\":\"ordinary\",\"amount\":\"10.00\",\"type\":\"expense\",\"status\":\"settled\",\"linked_transaction_id\":null"
        ",\"linked_account_name\":null,\"recurring_id\":null,\"date\":\"2026-01-05\",\"settled_date\":\"2026-01-05\",\"is_"
        "imported\":false,\"is_manual_adjustment\":false,\"is_reverted\":false,\"differs_from_series\":false,\"tags\":"
        "[]},{\"id\":2,\"account_id\":1,\"account_name\":\"Acct\",\"category_id\":1,\"category_name\":\"Home\",\"description"
        "\":\"adjustment\",\"amount\":\"20.00\",\"type\":\"expense\",\"status\":\"settled\",\"linked_transaction_id\":null,\"li"
        "nked_account_name\":null,\"recurring_id\":null,\"date\":\"2026-01-06\",\"settled_date\":\"2026-01-06\",\"is_impo"
        "rted\":false,\"is_manual_adjustment\":true,\"is_reverted\":false,\"differs_from_series\":false,\"tags\":[]},{"
        "\"id\":3,\"account_id\":1,\"account_name\":\"Acct\",\"category_id\":1,\"category_name\":\"Home\",\"description\":\"re"
        "jected\",\"amount\":\"30.00\",\"type\":\"expense\",\"status\":\"settled\",\"linked_transaction_id\":null,\"linked_ac"
        "count_name\":null,\"recurring_id\":null,\"date\":\"2026-01-07\",\"settled_date\":\"2026-01-07\",\"is_imported\":f"
        "alse,\"is_manual_adjustment\":false,\"is_reverted\":true,\"differs_from_series\":false,\"tags\":[]},{\"id\":4,"
        "\"account_id\":1,\"account_name\":\"Acct\",\"category_id\":2,\"category_name\":\"Utilities\",\"description\":\"sub "
        "row\",\"amount\":\"40.00\",\"type\":\"expense\",\"status\":\"settled\",\"linked_transaction_id\":null,\"linked_accou"
        "nt_name\":null,\"recurring_id\":null,\"date\":\"2026-01-08\",\"settled_date\":\"2026-01-08\",\"is_imported\":fals"
        "e,\"is_manual_adjustment\":false,\"is_reverted\":false,\"differs_from_series\":false,\"tags\":[]},{\"id\":6,\"a"
        "ccount_id\":1,\"account_name\":\"Acct\",\"category_id\":1,\"category_name\":\"Home\",\"description\":\"leg in\",\"am"
        "ount\":\"50.00\",\"type\":\"income\",\"status\":\"settled\",\"linked_transaction_id\":5,\"linked_account_name\":nul"
        "l,\"recurring_id\":null,\"date\":\"2026-01-09\",\"settled_date\":\"2026-01-09\",\"is_imported\":false,\"is_manual"
        "_adjustment\":false,\"is_reverted\":false,\"differs_from_series\":false,\"tags\":[]},{\"id\":5,\"account_id\":1"
        ",\"account_name\":\"Acct\",\"category_id\":1,\"category_name\":\"Home\",\"description\":\"leg out\",\"amount\":\"50.0"
        "0\",\"type\":\"expense\",\"status\":\"settled\",\"linked_transaction_id\":6,\"linked_account_name\":null,\"recurri"
        "ng_id\":null,\"date\":\"2026-01-09\",\"settled_date\":\"2026-01-09\",\"is_imported\":false,\"is_manual_adjustmen"
        "t\":false,\"is_reverted\":false,\"differs_from_series\":false,\"tags\":[]}],\"total\":6,\"limit\":50,\"offset\":0"
        "}"
    ),
    "type=expense&status=settled": (
        "{\"items\":[{\"id\":5,\"account_id\":1,\"account_name\":\"Acct\",\"category_id\":1,\"category_name\":\"Home\",\"descr"
        "iption\":\"leg out\",\"amount\":\"50.00\",\"type\":\"expense\",\"status\":\"settled\",\"linked_transaction_id\":6,\"li"
        "nked_account_name\":null,\"recurring_id\":null,\"date\":\"2026-01-09\",\"settled_date\":\"2026-01-09\",\"is_impo"
        "rted\":false,\"is_manual_adjustment\":false,\"is_reverted\":false,\"differs_from_series\":false,\"tags\":[]},"
        "{\"id\":4,\"account_id\":1,\"account_name\":\"Acct\",\"category_id\":2,\"category_name\":\"Utilities\",\"descriptio"
        "n\":\"sub row\",\"amount\":\"40.00\",\"type\":\"expense\",\"status\":\"settled\",\"linked_transaction_id\":null,\"link"
        "ed_account_name\":null,\"recurring_id\":null,\"date\":\"2026-01-08\",\"settled_date\":\"2026-01-08\",\"is_import"
        "ed\":false,\"is_manual_adjustment\":false,\"is_reverted\":false,\"differs_from_series\":false,\"tags\":[]},{\""
        "id\":3,\"account_id\":1,\"account_name\":\"Acct\",\"category_id\":1,\"category_name\":\"Home\",\"description\":\"rej"
        "ected\",\"amount\":\"30.00\",\"type\":\"expense\",\"status\":\"settled\",\"linked_transaction_id\":null,\"linked_acc"
        "ount_name\":null,\"recurring_id\":null,\"date\":\"2026-01-07\",\"settled_date\":\"2026-01-07\",\"is_imported\":fa"
        "lse,\"is_manual_adjustment\":false,\"is_reverted\":true,\"differs_from_series\":false,\"tags\":[]},{\"id\":2,\""
        "account_id\":1,\"account_name\":\"Acct\",\"category_id\":1,\"category_name\":\"Home\",\"description\":\"adjustment"
        "\",\"amount\":\"20.00\",\"type\":\"expense\",\"status\":\"settled\",\"linked_transaction_id\":null,\"linked_account_"
        "name\":null,\"recurring_id\":null,\"date\":\"2026-01-06\",\"settled_date\":\"2026-01-06\",\"is_imported\":false,\""
        "is_manual_adjustment\":true,\"is_reverted\":false,\"differs_from_series\":false,\"tags\":[]},{\"id\":1,\"accou"
        "nt_id\":1,\"account_name\":\"Acct\",\"category_id\":1,\"category_name\":\"Home\",\"description\":\"ordinary\",\"amou"
        "nt\":\"10.00\",\"type\":\"expense\",\"status\":\"settled\",\"linked_transaction_id\":null,\"linked_account_name\":n"
        "ull,\"recurring_id\":null,\"date\":\"2026-01-05\",\"settled_date\":\"2026-01-05\",\"is_imported\":false,\"is_manu"
        "al_adjustment\":false,\"is_reverted\":false,\"differs_from_series\":false,\"tags\":[]}],\"total\":5,\"limit\":5"
        "0,\"offset\":0}"
    ),
}
