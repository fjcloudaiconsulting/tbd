 ...
 *
 * ⚠ Only 22 of the 170 supported codes HAVE a symbol. For the other 148 `Intl`
 * echoes the code back ("BWP" -> "BWP"), which would render "BWP BWP", so that
 * case returns null and the caller omits the slot.
 *
