...
locals {
  ...
  apex_csp = join("; ", [
    ...
    "connect-src 'self' https://app.thebetterdecision.com https://www.google-analytics.com https://*.google-analytics.com https://*.analytics.google.com https://www.googletagmanager.com",
